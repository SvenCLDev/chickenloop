        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="mb-4 flex flex-wrap items-center gap-3">
            <button
              ...
              className="inline-flex items-center px-4 py-2 rounded-md font-medium bg-amber-500 text-white hover:bg-amber-600 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {featureLoading ? 'Redirecting...' : 'Feature this job'}
            </button>
            <span className="text-sm text-gray-500">Boost visibility for 14 days</span>
          </div>
          {error && (
