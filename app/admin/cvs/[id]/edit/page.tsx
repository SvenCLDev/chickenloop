...
export default function AdminEditCVPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await adminApi.updateCV(cvId, data);
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-white rounded-lg shadow-lg p-8">
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-3xl font-bold text-gray-900">Edit CV (Admin)</h1>
            <Link
              href="/admin"
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                Published CVs are visible to recruiters
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Select overall professional experience level
                </p>
              </div>
              <div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4">
              CV has been updated successfully
            </h2>
