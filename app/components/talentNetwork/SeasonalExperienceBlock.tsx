    ...
    <section className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-600 mt-1">
          Add seasonal deployments at watersports schools. Optional manager contact enables reference verification.
        </p>
      </div>
      ...
      {entries.map((entry, index) => (
        <div key={entry.clientId} className="border border-gray-200 rounded-lg p-4 space-y-4">
          ...
          <div className="border-t pt-4">
            <p className="text-sm font-medium text-gray-700 mb-3">Reference contact (optional)</p>
