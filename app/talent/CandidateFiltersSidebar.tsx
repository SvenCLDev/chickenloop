  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
      ...
      <div className="space-y-5">
        <div>
          ...
          <div className="space-y-4">
            ...
            <label className="flex items-center gap-2 cursor-pointer">
              ...
              />
              <span className="text-sm text-gray-700">Verified qualifications only</span>
            </label>
          </div>
        </div>
        ...
        <div>
          <p className="text-xs font-semibold uppercase tracking-wide text-gray-500 mb-3">Sort</p>
          <FilterSelect
            label="Sort order"
            value={filters.sort}
            ...
            options={[
              ...
              { value: 'oldest', label: 'Oldest profiles first' },
            ]}
